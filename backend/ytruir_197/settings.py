"""
Django settings for ytruir_197 project.
...
WSGI_APPLICATION = 'ytruir_197.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ytruir_197 API",
    "DESCRIPTION": "API documentation for ytruir_197 App",
    "VERSION": "v1",
}
